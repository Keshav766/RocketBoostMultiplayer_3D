    ...
    void ProcessFiringPlasmaBullets()
    {
        ...
        Debug.Log("enetred here");
        {
            if (bulletCount > 0)
            {
                ...
                PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "PlasmaBullet"), playerBulletRef.transform.position, playerBulletRef.transform.rotation);
            }
